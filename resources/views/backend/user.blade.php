                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Phone1" name="phone1" value="{{ old('phone1') }}">
                                            @error('phone1')
                                            <span class="invalid-feedback" role="alert">
                                                <strong class="red">{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            <label>Phone2</label>
                                            <input type="text" class="form-control" placeholder="Phone2" name="phone2" value="{{ old('phone2') }}">
                                            @error('phone2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong class="red">{{ $message }}</strong>
                                            </span>
