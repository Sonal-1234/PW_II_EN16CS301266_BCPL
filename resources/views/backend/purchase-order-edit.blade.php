                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="input-group col-lg-12">
                                                            ...
                                                            <select name="customer_id" class="form-control selectCustomer" disabled required>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group col-lg-12">
                                                            ...
                                                            <select name="account_id" class="form-control selectAccountNumber" disabled required>
                                                    ...
                                                    <div class="col-lg-4 col-md-12 col-xs-12">
                                                        <div class="form-group" style="margin-bottom: 0;">
                                                            <div class="input-group wide-tip">
                                                                ...
                                                                <select name="plan" class="form-control col-lg-8" required>
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table items table-striped table-bordered table-condensed table-hover">
                                                            ...
                                                            <tr id="tfoot" class="tfoot active">
                                                                <th colspan="5"><span class="pull-right"><strong class="text-success">Total Amount :</strong></span></th>
                                                                <th class="text-right">
