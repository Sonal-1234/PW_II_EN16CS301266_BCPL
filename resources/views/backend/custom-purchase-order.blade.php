                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            @endif
                            <div class="row">
                                <form class="form-horizontal form-label-left" action="{{ route('custom-purchase-store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            <div class="x_title">
                                            ...
                                            <div class="x_content">
                                                <div class="row">
                                                    <table id="myTable" class=" table">
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td class="col-sm-3"><input type="text" name="plan" class="form-control"/></td>
                                                            <td class="col-sm-3"><input type="text" name="plan_sac_code" class="form-control"/></td>
                                                            <td class="col-sm-3"><input type="number" min="0" name="plan_frequency" class="form-control planFrequency"/></td>
                                                            <td class="col-sm-3"><input type="number" min="0" name="plan_price" class="form-control subTotal planPrice"/></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            ...
                                            <div class="x_content">
                                                <div class="row">
                                                    <table id="myTable" class=" table order-list">
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td class="col-sm-3"><input type="text" name="product_name[]" class="form-control"/></td>
                                                            <td class="col-sm-2"><input type="text" name="sac_code[]" class="form-control"/></td>
                                                            <td class="col-sm-2"><input type="number" min="0" name="quantity[]" class="form-control"/></td>
                                                            <td class="col-sm-2"><input type="number" min="0" name="discount[]" class="form-control"/></td>
                                                            <td class="col-sm-2"><input type="number" min="0" name="price[]" class="form-control subTotal"/></td>
